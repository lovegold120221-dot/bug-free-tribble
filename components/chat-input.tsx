      ...
      return (
        <div className="relative" key={file.name}>
          <span
            ...
            className="absolute top-[-8px] right-[-8px] bg-muted rounded-full p-1 z-20 shadow-sm hover:bg-accent cursor-pointer border"
          >
            <X className="h-3 w-3" />
          </span>
          {isImage ? (
            <img
              ...
              alt={file.name}
              className="rounded-xl w-10 h-10 object-cover border"
            />
          ) : (
            <div className="rounded-xl w-10 h-10 flex items-center justify-center bg-muted border">
  ...
  return (
    ...
    >
      ...
      <p className="text-xs text-muted-foreground mt-2 text-center">
        Fragments is an Eburon Project
      </p>
    </form>
  )
}
